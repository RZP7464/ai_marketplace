...
function BrandIdentity({ onNext, onBack }) {
  ...
  const handleLogoUpload = (e) => {
    ...
    if (file) {
      if (file.size > 5 * 1024 * 1024) {
        setErrors((prev) => ({
          ...prev,
          display_logo: "File size must be less than 5MB",
        }));
        return;
      }
      if (!file.type.startsWith("image/")) {
        setErrors((prev) => ({
          ...prev,
          display_logo: "Please upload an image file",
        }));
        return;
      }
  ...
  const addCustomCategory = () => {
    if (
      customCategory.trim() &&
      !formData.display_category.includes(customCategory.trim())
    ) {
      setFormData((prev) => ({
        ...prev,
    ...
    <div className="sticky top-8">
              ...
              <div className="flex gap-2">
                ...
                >
                  {formData.display_message ||
                    `👋 Welcome to ${
                      formData.display_name || "our store"
              ...
              <div className="px-3 py-2 border-t border-gray-800 bg-gray-900">
                <div className="flex gap-1.5 overflow-x-auto pb-1 scrollbar-hide">
                  ...
                  {formData.display_category.length > 3 && (
                    <span className="flex-shrink-0 px-2 py-1 rounded-full text-[9px] text-gray-400 bg-gray-800">
                      +{formData.display_category.length - 3}
                    </span>
                  )}
                </div>
      ...
      <div className="mt-4 p-3 bg-[#2a2a4a]/50 rounded-xl border border-gray-700/50">
        <p className="text-gray-400 text-xs">
          💡 This is how your AI assistant will appear to customers. Colors,
          logo, and messages update in real-time.
        </p>
      </div>
    </div>
  );
  ...
  return (
    <div className="min-h-screen bg-[#1a1a2e] flex items-center justify-center p-4 relative overflow-hidden">
      ...
      <div className="relative w-full max-w-6xl flex gap-8">
        ...
        <div className="flex-1 max-w-2xl bg-[#252542] rounded-3xl shadow-2xl overflow-hidden">
          ...
          <div className="p-8 bg-[#1e1e3f]">
            ...
            <p className="text-gray-400 text-sm mb-8">
              Tell us about your brand to personalize your AI agent
            </p>
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div className="flex-1">
                    <p className="text-gray-500 text-xs">
                      ...
                      <br />
                      Max file size: 5MB. Formats: PNG, JPG, SVG
                    </p>
                    {errors.display_logo && (
              ...
              <div>
                ...
                <div className="flex justify-between mt-1">
                  ...
                  <p className="text-gray-500 text-xs ml-auto">
                    {formData.display_tagline.length}/100
                  </p>
                </div>
              </div>
              ...
              <div>
                ...
                <p className="text-gray-500 text-xs mt-1 text-right">
                  {formData.display_message.length}/250
                </p>
              </div>
              ...
              <div>
                ...
                >
                  <div className="flex items-center gap-3 mb-3">
                    ...
                    <div>
                      ...
                      <p className="text-gray-400 text-xs">
                        {formData.display_tagline || "Your tagline here"}
                      </p>
                    </div>
                  </div>
                  <div className="flex gap-2">
                ...
                <p className="text-gray-500 text-xs mt-2">
                  🎨 These colors will be used throughout your store to match
                  your brand identity
                </p>
              </div>
              ...
              <div>
                <label className="block text-gray-400 text-xs mb-2">
                  ...
                  <span className="text-gray-600">
                    (Select or create your own with emojis! 🎉)
                  </span>
                </label>
        ...
        {/* Right Side - Preview */}
        <div className="hidden lg:block">{renderPreviewPanel()}</div>
      </div>
    </div>
  );
}
